...
class SignalController extends Controller
{
    ...
    public function receiveSignal(Request $request)
    {
        ...
        $signal->firstprofit = $signal_data;
        $signal->mark = "exam";
        $signal->mode = "exam";
        $signal->entrymin = "exam";
        $signal->entrymax = "exam";
        $signal->secondprofit = "secondprofit";
        $signal->thirdprofit = "thirdprofit";
        $signal->lossprofit = "lossprofit";
